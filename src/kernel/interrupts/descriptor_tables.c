...
static void InitGDT() {
	...
	GDTSetGate(1, 0, 0xFFFFFFFF, pack_access(0b1010, 0b1, 0b00, 0b1), pack_granularity(0b0, 0b1, 0b1)); 	//Kernel Code segment
	GDTSetGate(2, 0, 0xFFFFFFFF, pack_access(0b0010, 0b1, 0b00, 0b1), pack_granularity(0b0, 0b1, 0b1));	//Kernel Data segment
